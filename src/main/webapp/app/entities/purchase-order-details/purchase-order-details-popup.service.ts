...
@Injectable()
export class PurchaseOrderDetailsPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.purchaseOrderDetailsService.find(id).subscribe((purchaseOrderDetails) => {
                    this.ngbModalRef = this.purchaseOrderDetailsModalRef(component, purchaseOrderDetails);
                    resolve(this.ngbModalRef);
                });
            } else {
                // setTimeout used as a workaround for getting ExpressionChangedAfterItHasBeenCheckedError
                setTimeout(() => {
                    this.ngbModalRef = this.purchaseOrderDetailsModalRef(component, new PurchaseOrderDetails());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    purchaseOrderDetailsModalRef(component: Component, purchaseOrderDetails: PurchaseOrderDetails): NgbModalRef {
