...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/extra-user'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ExtraUser) {
        return item.id;
    }
    registerChangeInExtraUsers() {
        this.eventSubscriber = this.eventManager.subscribe('extraUserListModification', (response) => this.loadAll());
    }
